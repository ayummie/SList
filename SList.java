...
public class SList {
  ...
  public static void main (String[] args) {
    SList myC = new SList(); // Fill in your solution for Part I here.
    myC.insertEnd(new Integer(9));
    myC.insertFront(new Integer(6));
    myC.insertEnd(new Integer(12));
    System.out.println(myC);
    myC.insertFront(new Integer(3));
    myC.insertEnd(new Integer(15));
    System.out.println(myC);
